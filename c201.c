...
void List_Dispose( List *list ) {
	ListElementPtr removeEl = list->firstElement;
...
void List_DeleteAfter( List *list ) {
	if (list->activeElement != NULL) 
	{
		...
		{
			// uloží následující do deleteAfterPtr, přepíše následující na následující
			// po deleteAfterPtr a uvolní paměť
			ListElementPtr deleteAfterPtr = list->activeElement->nextElement;
			list->activeElement->nextElement = deleteAfterPtr->nextElement;
			free(deleteAfterPtr);
		}
	}
}
...
void List_InsertAfter( List *list, int data ) {
	if (list->activeElement != NULL)
	{
		...
		// Následující po novém je následující po aktivním a poté následují po
		// aktivním na nový
		newElementPtr->data = data;
